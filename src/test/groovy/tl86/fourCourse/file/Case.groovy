...
class Case extends Specification {
    ...
    def "should create and read txt file successfully"() {
        ...
        def file = fileService.createFile("./src/test/resources/tl86/data/test.txt")
    ...
    def "should read yml file successfully"() {
        ...
        def configs = fileService.getConfigs('./src/test/resources/tl86/config/config.yml')
        then: "print data"
    ...
    def "should read csv file successfully"() {
        ...
        def csvContent = fileService.getCsvFileContent('./src/test/resources/tl86/data/test.csv', ',')
    ...
    def "should read json file successfully"() {
        ...
        def jsonContent = fileService.getCollectionFromJsonFile('./src/test/resources/tl86/data/test.json')
        then: "println the data"
    ...
    def "should read xml file successfully"() {
        given: ""
        when: "get json file data"
        def xmlContent = fileService.getCollectionFromXMLFile('./src/test/resources/tl86/data/test.xml')
        then: "println the data"
